...
export default function PhotoCard({
  ...
  const handleShare = async (e: React.MouseEvent) => {
    ...
    try {
      ...
      const customShareUrl = `${baseUrl}/shared-photo?url=${encodeURIComponent(
        presignedUrl
      )}`;
    ...
    <>
      <div
        className={`photo-card ${
          photo.status === "inactive" ? "recycled" : ""
          ...
          <div className="flex mt-2">
            {photo.status === "active" && (
              <>
                ...
                >
                  {isDeleting ? (
                    <span className=" border-white border-t-transparent">
                      Recycling...
                    </span>
                  ) : (
